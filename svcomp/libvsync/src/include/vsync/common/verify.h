...
/*******************************************************************************
 * @def VSYNC_USE_VERIFIER_LOOP_BOUND
 * @brief enables functions based on __VERIFIER_loop_bound.
 ******************************************************************************/
#ifdef DOC
    #define VSYNC_USE_VERIFIER_LOOP_BOUND
#elif defined(VSYNC_USE_VERIFIER_LOOP_BOUND)

static inline void
verification_loop_bound(vuint32_t bound)
{
    __VERIFIER_loop_bound((int)bound);
}
#else
static inline void
verification_loop_bound(vuint32_t bound)
